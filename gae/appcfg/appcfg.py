...
#DIR_PATH = get_dir_path(os.path.join('lib', ''))
...
def _google_create_connection(address, timeout=None):
  msg = "getaddrinfo returns an empty list"
  host, port = address
  import socket
  google_hosts = ["www.google.com.hk","maps.google.com","www.google.com.tw","mail.google.com","www.google.co.jp","www.google.co.kr"]
...
def adjust_fancy_urllib():
   import fancy_urllib
   if os.environ.get('http_proxy') == None  and  os.environ.get('HTTP_PROXY') == None and os.environ.get('https_proxy') == None  and  os.environ.get('HTTPS_PROXY') == None:
    fancy_urllib._create_connection = _google_create_connection
